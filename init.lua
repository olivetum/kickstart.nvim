...
-- In visual mode, J moves selected text down one line and reindents
vim.keymap.set('v', 'J', ":m '>+1<CR>gv=gv")
-- In visual mode, K moves selected text up one line and reindents
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>pb', ':Telescope file_browser<CR>', { desc = 'File [B]rowser' })
